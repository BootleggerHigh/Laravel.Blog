...
<head>
    ...
    <title>{{$title ?? 'Неизвестная страница'}}</title>
...
<footer id="sticky-footer" class="py-10 bg-dark text-white-50 ">
    <div class="container text-center">
        <span><a href="https://github.com/BootleggerHigh">BootleggerHigh </a> &copy; Laravel</span>
    </div>
</footer>
</html>
